...
// -- Welcome Screen Text
const String tWelcomeTitle = "Coolstuff Market!";
const String tWelcomeSubTitle = "El marketplace en donde conectarás mas rápidamente con tus clientes";


// -- Login Screen Text
const String tLoginTitle = "Iniciar Sesión";
const String tLoginSubTitle = "Hola, gusto en verte otra vez!.";
...
const String tForgetPasswordTitle = "Selecciona una opción.";
const String tForgetPasswordSubTitle = "Confirma el método para recuperar la contraseña.";

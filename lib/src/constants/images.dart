...
// -- User Screen images
const String tEstrellaIcon = "assets/images/estrella-icon.png";
const String tUserIcon = "assets/images/icon-usuario.png";
const String tWppIcon = "assets/images/whatsapp-icon.png";
const String tProductoIcon = "assets/images/producto1.png";